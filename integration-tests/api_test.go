...
func TestAPI(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			http.MethodPost,
			[]byte(`{"order_id":"o123456789","customer":{"name":"lorem ipson"},"details":{"amount":100,"installments":1,"payment_type":"credit","card":{"source_id":"authorized","brand":"Visa","expiration_month":12,"expiration_year":2020},"itens":["lorem","ipson"]},"establishment":{"address":"rua lorem ipson","identifier":"00.111.222-8","postal_code":12345678}}`),
			200,
		...
		},
		{
			...
			"http://localhost:3000/payment/cielo",
			http.MethodPost,
			[]byte(`{"order_id":"o123456789","customer":{"name":"lorem ipson"},"details":{"amount":100,"installments":1,"payment_type":"credit","card":{"source_id":"inexistent","brand":"Visa","expiration_month":12,"expiration_year":2020},"itens":["lorem","ipson"]},"establishment":{"address":"rua lorem ipson","identifier":"00.111.222-8","postal_code":12345678}}`),
			400,
		...
		},
		{
			...
			"http://localhost:3000/payment/cielo",
			http.MethodPost,
			[]byte(`{"order_id":"integration-error","customer":{"name":"lorem ipson"},"details":{"amount":100,"installments":1,"payment_type":"credit","card":{"source_id":"authorized","brand":"Visa","expiration_month":12,"expiration_year":2020},"itens":["lorem","ipson"]},"establishment":{"address":"rua lorem ipson","identifier":"00.111.222-8","postal_code":12345678}}`),
			400,
		...
		},
		{
			...
			"http://localhost:3000/payment/cielo",
			http.MethodPost,
			[]byte(`{"order_id":"emissor-error","customer":{"name":"lorem ipson"},"details":{"amount":100,"installments":1,"payment_type":"credit","card":{"source_id":"authorized","brand":"Visa","expiration_month":12,"expiration_year":2020},"itens":["lorem","ipson"]},"establishment":{"address":"rua lorem ipson","identifier":"00.111.222-8","postal_code":12345678}}`),
			400,
		...
		},
		{
			...
			"http://localhost:3000/payment/cielo",
			http.MethodPost,
			[]byte(`{"customer":{"name":"lorem ipson"},"details":{"amount":100,"installments":1,"payment_type":"credit","card":{"source_id":"authorized","brand":"Visa","expiration_month":12,"expiration_year":2020},"itens":["lorem","ipson"]},"establishment":{"address":"rua lorem ipson","identifier":"00.111.222-8","postal_code":12345678}}`),
			400,
		...
		},
		{
			...
			"http://localhost:3000/payment/rede",
			http.MethodPost,
			[]byte(`{"order_id":"business-error","customer":{"name":"lorem ipson"},"details":{"amount":100,"installments":1,"payment_type":"credit","card":{"source_id":"authorized","brand":"Visa","expiration_month":12,"expiration_year":2020},"itens":["lorem","ipson"]},"establishment":{"address":"rua lorem ipson","identifier":"00.111.222-8","postal_code":12345678}}`),
			400,
